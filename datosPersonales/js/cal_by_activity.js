...
var color = d3.scale.ordinal()
    .range(["#ccebc5", "#decbe4", "#fed9a6", "#fbb4ae"]);
...
d3.csv("/data/cal_by_activity.csv", function(error, data) {
  if (error) throw error;

  color.domain(d3.keys(data[0]).filter(function(key) { return key !== "Activity"; }));
  ...
  var activity = svg4.selectAll(".activity")
      .data(data)
    .enter().append("g")
      .attr("class", "g")
      .attr("transform", function(d) { return "translate(" + x(d.Activity) + ",0)"; });
